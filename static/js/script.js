var LANGUAGES = {
    "_": { defaultLanguage: "es", defaultVOLanguage: "es", defaultSpeed: 20, defaultRandmo: "off" },
    "es": {
        audioList: [
        ...
        texts: {
            ...
            "doc-title": "Kuru Kuru~",
            "page-descriptions": "La página para Alya, la <del>única</del> waifu en el corazón de Rubén.",
            "counter-descriptions": ["La kuru~ ha sido exprimida por", "Alya ha sido kuru~ada por"],
            "counter-unit": "veces",
            "counter-button": ["Exprimir a la kuru~!", "Kuru kuru~!"],
            ...
            "options-txt-vo-lang": "Lenguaje de voz",
            "options-txt-random_speed": "Velocidad aleatoria",
            "options-txt-speed": "Velocidad",
            "options-txt-lang": "Lenguaje de sitio",
            "dialogs-close": "Cerrar",
            "dialogs-credits-title": "Creditos",

            "CREDITS:main-dev": "Desarrollador principal",
            "CREDITS:code-contributor": "Contribuidor de código",
            "CREDITS:artist": "Artista",
            "CREDITS:localization": "Contribuidor de localización",
            "CREDITS:localization:Korean": "Contribuidor de localización koreana",
            "CREDITS:localization:Japanese": "Contribuidor de localización japonesa",
            "CREDITS:localization:Indonesian": "Contribuidor de localización de Indonesia",
